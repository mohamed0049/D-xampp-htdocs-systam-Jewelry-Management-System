...
if(isset($_POST['submit']))
  {
   ...
   $orderid=$_GET['oid'];
    ...
    $query = mysqli_query($con, "insert into tbltracking(OrderId,remark,status,OrderCanclledByUser) values('$orderid','$remark','$ressta','$canclbyuser')");
    if (!$query) {
        echo "Error: " . mysqli_error($con);
    }
    
    $query = mysqli_query($con, "update tblorderaddresses set Status='$ressta' where Ordernumber='$orderid'");
    if (!$query) {
        echo "Error: " . mysqli_error($con);
    }
